class EventSeries
  ...
  def create_events
    ...
    days.each do |day|
      ...
      self.events.create(:title => title, :description => description, :all_day => all_day, :start_time => st, :category => category, :institution_id => institution_id, :location => location)
    end
  end
