Churchapp::Application.routes.draw do
  ...
  match "/:church_id/photos/:id", :to => 'photos#show', :as => :original_photo
  match "/:church_id/articles/:id", :to => 'articles#show', :as => :single_article
  
  match "/(:church_id)/pages/:id", :to => 'pages#show', :as => :church_page
