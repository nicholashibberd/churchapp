...
describe MessagesController do
  ...
  describe "when not logged in" do
    ...
    before(:each) do
      ...
      @message = Factory(:message, :church_id => @institution.id)
      @page = Factory(:page)      
    end
    ...
    it "should restrict access to the show action" do
      get 'show', :church_id => @institution.slug, :id => @message.id
      response.should be_redirect
      response.location.should == 'http://www.example.com/signin'
    end
    ...
    it "should handle the create and redirect back to the previous page when valid" do
      ...
      post 'create', :message => Factory.attributes_for(:message), :page_id => @page.id, :church_id => @institution.slug
      response.should be_redirect
      response.location.should include church_page_path(@institution, @page)
    end 
  ...
  describe "when logged in" do
    ...
    it "should destroy the message and return to the index page" do
      lambda do
        ...
        response.should redirect_to messages_path(@institution)
